            ...
            <div className="resume-hover">
              ...
              <div className="w3-deep-orange w3-center w3-dropdown-hover resume-grid-item">
                ...
                <div className="w3-dropdown-content w3-bar-block w3-card" style={{width: "100%", overflow: "auto"}}>
                  ...
                  <div className="w3-bar-item w3-text w3-text-pink"><b>Self-taught Developer Bootcamp</b></div>
                  <a className="w3-bar-item w3-text w3-hover-pink" href="https://google.ca" target="_blank" rel="noopener noreferrer"><b>Full Stack Web Developing</b> at <i>Self-taught</i></a>
                </div>
              </div>
              <div className="w3-deep-orange w3-center w3-dropdown-hover resume-grid-item">
              ...
              <div class="w3-center">
                ...
                <div class="w3-container w3-margin">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">Flair Flexible Packaging - Calgary, AB</h5>
                      <div class="w3-left-align w3-margin-left">- Implemented corrective action plans and successfully reduced quality related non-conformance incidents improving the company’s bottom line.</div>
                      <div class="w3-left-align w3-margin-left">- Maintained proactive quality management systems to build and strengthen the company’s brand as a high quality flexible packaging supplier.</div>
                      <div class="w3-left-align w3-margin-left">- Collected and analyzed quality control data trends to develop prevention and reduction strategies in quality related incidents.</div>
                      <div class="w3-left-align w3-margin-left">- Corresponded with overseas third party suppliers and customer service representatives to uphold the quality control standards of the products and maximize customer satisfaction.</div>
                      <div class="w3-left-align w3-margin-left">- Created and revised Technical Die Lines to the correct specifications and standards using Adobe Illustrator.</div>
                  </div>
                  <div class="w3-col w3-quarter w3-padding-large w3-center">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">Days Inn & Conference Center by Wyndham Bridgewater - Bridgewater, NS</h5>
                      <div class="w3-left-align w3-margin-left">- Managed the front-end operations of a hotel, managing 10 to 15 employees to deliver high level of customer service.</div>
                      <div class="w3-left-align w3-margin-left">- Analyzed key business metrics for the business owner to help evaluate the revenue model and improve the bottom line.</div>
                      <div class="w3-left-align w3-margin-left">- Performed general accounting and administrative duties including payroll, bookkeeping, and generating financial reports using Sage50.</div>
                  </div>
                  <div class="w3-col w3-quarter w3-padding-large w3-center">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">CF Industries - Medicine Hat, AB</h5>
                      <div class="w3-left-align w3-margin-left">- Managed several small to medium sized projects simultaneously in troubleshooting and optimizing process operations to help improve production efficiency and safety.</div>
                      <div class="w3-left-align w3-margin-left">- Built process models using Aspen HYSYS and Aspen Plus software to verify and validate engineering calculations.</div>
                      <div class="w3-left-align w3-margin-left">- Prepared high level proposals, scopes, presentations, and technical reports for key project stakeholders.</div>
                      <div class="w3-left-align w3-margin-left">- Executed and closed projects within the allocated budget and deadline through effective scoping and planning.</div>
                      <div class="w3-left-align w3-margin-left">- Coordinated in multidisciplinary teams to meet project deliverables in a timely manner and promote good teamwork.</div>
                  </div>
                  <div class="w3-col w3-quarter w3-padding-large w3-center">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">OEM Remanufacturing - Edmonton, AB</h5>
                      <div class="w3-left-align w3-margin-left">- Managed document control in the collection, validation, and storage of documents according to the company's policies and standards.</div>
                      <div class="w3-left-align w3-margin-left">- Worked closely with machine operators and welders in the field to create technical procedural documents.</div>
                      <div class="w3-left-align w3-margin-left">- Utilized the company’s document control software to assist in implementing document control standards.</div>
                      <div class="w3-left-align w3-margin-left">- Created and validated mechanical specification drawings using AutoCAD.</div>
                  </div>
                  <div class="w3-col w3-quarter w3-padding-large w3-center">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">West Fraser - Slave Lake, AB</h5>
                      <div class="w3-left-align w3-margin-left">- Assisted in the project management of the Green Transformation Project to help reduce the company's carbon footprint and stay ahead of the environmental regulations and policies.</div>
                      <div class="w3-left-align w3-margin-left">- Managed the procurement of equipment and services in accordance with the project budget and schedule to promote project completion in a timely manner.</div>
                      <div class="w3-left-align w3-margin-left">- Supervised outside contractors to ensure all standards and specifications were met out in the field.</div>
                      <div class="w3-left-align w3-margin-left">- Reviewed Piping and Instrumental Drawings (P&IDs), construction drawings, and mechanical drawings to ensure that the correct industry codes and standards was upheld.</div>
                      <div class="w3-left-align w3-margin-left">- Utilized Microsoft Projects to track and update the progression of the project in organized manner.</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="resume-content">
              <div class="w3-center">
                ...
                <div class="w3-container w3-margin">
                  ...
                  <div class="w3-col w3-threequarter w3-padding-large w3-leftbar w3-border-pink">
                      <h5 class="w3-left-align">University of Alberta</h5>
                      <div class="w3-left-align w3-margin-left">Bachelor of Science in Chemical Engineering with 20-month of Cooperative Work Experience</div>
                </div>
              </div>
            </div>
            </div>
